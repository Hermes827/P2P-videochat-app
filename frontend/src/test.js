...
constructor(){
 ...
 callAction(e) {
   ...
   localPeerConnection.addEventListener('onicecandidate', this.handleConnection);
   ...
   // remotePeerConnection.addEventListener('onaddstream', this.gotRemoteMediaStream);
   // this.gotRemoteMediaStream(remotePeerConnection)
   //
 ...
 render() {
   return (
     ...
     <video id="localVideo" autoPlay="true" ref={this.localRef}></video>
     <video id="remoteVideo" autoPlay="true" ref={this.remoteRef}></video>
     <button onClick={this.turnOnVideo}>turn on video</button>
       <button id="startButton" onClick={this.random}>Start</button>
